function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Car_Climb_Racing.loader.js";
		var config = {
        dataUrl: buildUrl + "/Car_Climb_Racing.data",
        frameworkUrl: buildUrl + "/Car_Climb_Racing.framework.js",
        codeUrl: buildUrl + "/Car_Climb_Racing.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Car Climb Racing",
        productVersion: "1",
      };
